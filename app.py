...
def about():
    text = ""
    if 'username' in session:
        text = "You are logged in " + session["username"]#didn't want to authenticate this since it's a specific case. If there were more cases, prob make a new wrapper so i can factor
